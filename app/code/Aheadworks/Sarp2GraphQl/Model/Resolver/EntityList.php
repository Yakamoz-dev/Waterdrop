...
use Aheadworks\Sarp2GraphQl\Model\Resolver\DataProvider\DataProviderInterface;
use Aheadworks\Sarp2GraphQl\Model\Resolver\DataProvider\SearchResult;
...
class EntityList extends AbstractResolver
{
    ...
    public function performResolve(
        ...
        $args['filter']['customer_id']['eq'] = $this->getCustomerId($context);
