...
abstract class AbstractPost extends \Magento\Framework\View\Element\Template
{
    ...
    public function getInfoHtml2()
    {
        return $this->getInfoBlock2()->toHtml();
    }
    ...
    /**
     * Retrieve post viewinfo block
     *
     * @return \Magefan\Blog\Block\Post\ViewInfo
     */
    public function getInfoBlock2()
    {
        $k = 'info_block';
        if (!$this->hasData($k)) {
            $blockName = $this->getPostInfoBlockName();
