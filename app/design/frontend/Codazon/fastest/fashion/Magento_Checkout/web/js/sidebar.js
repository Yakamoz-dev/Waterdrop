...
define([
    ...
    $.widget('mage.sidebar', {
        ...
        _initContent: function () {
             ...
             * @param {jQuery.Event} event
             */
            events['click ' + '.minicart-items-wrapper .minicart-id-qty-plus'] = function (event) {//Custom event
             ...
             * @param {jQuery.Event} event
             */
            events['click ' + '.minicart-items-wrapper .minicart-id-qty-minus'] = function (event) {//Custom event
                var qtyVal = parseInt($(event.target).parent().find(this.options.item.qty).val());
                if(qtyVal > 1){
                    $(this.options.item.qty).val(qtyVal - 1);
                    event.stopPropagation();
