...
return [
    'modules' => [
        ...
        'Ecomteck_AdvancedContact' => 1,
        'Ecopure_Checkout' => 1,
        'Ecopure_Gift' => 1,
        'Ecopure_Review' => 1,
        'Ecopure_Salessequence' => 1,
        'Ecopure_Simpleshipping' => 1,
        'Ecopure_Tongtool' => 1,
        'Ecopure_TrackingNumber' => 1,
        ...
        'Mageside_KeepAdminAuthorized' => 1,
        'Nordcomputer_Showoutofstockprice' => 1,
        'OlegKoval_RegenerateUrlRewrites' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Prymag_ReviewsImporter' => 1,
