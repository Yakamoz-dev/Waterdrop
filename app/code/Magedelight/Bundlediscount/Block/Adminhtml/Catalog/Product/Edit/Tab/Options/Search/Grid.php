...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->setStore($this->getStore())
                ...
                ->addStoreFilter()
                ->addAttributeToFilter('type_id', ['simple', 'downloadable', 'configurable', 'bundle', 'virtual'])
                ->addAttributeToFilter('entity_id', ['neq' => $this->_currentProductId]);
