...
class TagwrapperstatusActions extends Column
{
    /** Url path */
    const BLOG_URL_PATH_EDIT = 'gridmanager/tagwrapper/edit';
    const BLOG_URL_PATH_DELETE = 'gridmanager/tagwrapper/delete';
