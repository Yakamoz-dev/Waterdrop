...
class TagcategoriesstatusActions extends Column
{
    /** Url path */
    const BLOG_URL_PATH_EDIT = 'gridmanager/tagcategories/edit';
    const BLOG_URL_PATH_DELETE = 'gridmanager/tagcategories/delete';
