...
class Bundlediscount extends \Magento\Backend\Block\Widget implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareLayout()
    {
        $this->addChild(
            ...
            ['label' => __('Add New Bundle'), 'class' => 'add action-default primary',
                'id' => 'add_new_defined_bundle', 'on_click' => 'pbOption.add()']
        );
        $this->addChild(
            'md_bundlediscount_options_box',
            'Magedelight\Bundlediscount\Block\Adminhtml\Catalog\Product\Edit\Tab\Options\Option'
        );
